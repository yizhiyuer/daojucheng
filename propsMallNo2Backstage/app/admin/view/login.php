                            ...
                            <fieldset>
                                <ul class="login-form-box">
                                    <li class="frame_style form_error"><label class="user_icon"></label><input
                                            name="用户名" type="text" id="user_name"/><i>用户名</i></li>
                                    <li class="frame_style form_error"><label class="password_icon"></label><input
                                            name="密码" type="password" id="user_password"/><i>密码</i></li>
                                    <li class="frame_style form_error"><label class="Codes_icon"></label><input
                                        ...
                                        <div class="Codes_region">
                                            <img src="../models/vcode/vcodeImg.php"
                                                 onclick="this.src='../models/vcode/vcodeImg.php?v='+Math.random()">
                                        </div>
                                    </li>
                                ...
                                <div class="clearfix text-center">
                                    ...
                                    <button type="button" class="width-50  btn btn-sm btn-primary"
                                            id="login_btn">
                                        <i class="icon-key"></i>
                                        登陆
                                    </button>
